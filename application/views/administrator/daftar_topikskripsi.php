<div class="container-fluid">
  ...
  <div class="alert custom-alert" role="alert">
    <i class="fas fa-university"></i> Cetak Sertifikat Kegiatan Praktik Kerja Lapangan
  </div>
  ...
  <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal" style="margin-left: 1580px;">
    Cetak
  </button>
  <!-- Modal -->
